...
<body style="background-image:url(../../img/fondo_n.jpg)">
  ...
  <div class="containerTablaFiltro align-items-center justify-content-center">
    <h1 class="tituloAlumnoNuevo">Modificar Docente</h1>
    <form action="{{url('/profesor/'.$profesor->id)}}" method="post" style="text-align:center" enctype="multipart/form-data">
      @csrf
      {{method_field('PATCH')}}
      <div class="row" style="margin:0 auto;left:50px;text-align:center;top:10px">

        <div class="col-lg-5">
          <img src="{{asset('storage').'/'.$profesor->Foto}}" alt="" width="190">
          <div id="div_file">
            <p>Examinar</p>
        ...
        <div class="col-lg-3 teacher_box_col">
          ...
          <div class="filtro">
            ...
            <input type="text" value="{{ $profesor->Telefono }}" name="Telefono" id="Telefono" />
          </div>
          <div class="filtro">
        ...
        <div class="col-lg-3 teacher_box_col">
          <div class="filtro">
            ...
            <input type="text" value="{{ $profesor->Correo }}" name="Correo" id="Correo" />
          </div>
          <div class="filtro">
            <h2 class="titleInformatio" for="Cedula">Cedula</h2>
            <input type="text" value="{{ $profesor->Cedula }}" name="Cedula" id="Cedula" />
          </div>
          <div class="filtro">
            <h2 class="titleInformatio" for="Grado_id">Grado</h2>
            <select name="Grado_id" id="Grado_id">
              <option selected class="form-control">{{ $profesor->grade->Grade }}</option>
