      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 hero_box_col">
            <a class="hero_box d-flex flex-row align-items-center justify-content-start" href="{{url('/notes')}}">
          ...
          <div class="col-lg-6 hero_box_col">
            <a class="hero_box d-flex flex-row align-items-center justify-content-start" href="{{url('/notesaber')}}">
              <i class="fas fa-tasks"></i>
              <div class="hero_box_content">
